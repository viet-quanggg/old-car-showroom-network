<%-- 
    Document   : carlist
    Created on : May 28, 2023, 9:36:26 AM
    Author     : _viet.quangg
--%>
                        ...
                        <div class="col-xl-12">
                            <div class="top-filter">
                                ...
                                <div class="filter-action"><a href="<c:url value="/cars/cargrid.do"/>" title="Grid View"
                                        class="material-icons">grid_view</a><a href="<c:url value="/cars/carlist.do"/>"
                    ...
                    <div class="row row-cols-1 row-cols-sm-1 row-cols-md-2 row-cols-lg-2 row-cols-xl-1">
                        <div class="col">
                            <div class="product-list-card">
                                <div class="product-list-image"><img src="${pageContext.request.contextPath}/mironmahmud.com/ghurnek/assets/images/product/01.jpg" alt="product">
                        ...
                        <div class="col">
                            <div class="product-list-card">
                                <div class="product-list-image"><img src="${pageContext.request.contextPath}/mironmahmud.com/ghurnek/assets/images/product/02.jpg" alt="product">
                        ...
                        <div class="col">
                            <div class="product-list-card">
                                <div class="product-list-image"><img src="${pageContext.request.contextPath}/mironmahmud.com/ghurnek/assets/images/product/03.jpg" alt="product">
                                    <div class="product-list-badge"><label class="badge new">new</label></div>
                                    <div class="product-list-hints"><i
                                            class="material-icons">collections</i><span>4</span></div>
                                    <div class="product-list-overlay">
                        ...
                        <div class="col">
                            <div class="product-list-card">
                                <div class="product-list-image"><img src="${pageContext.request.contextPath}/mironmahmud.com/ghurnek/assets/images/product/04.jpg" alt="product">
                        ...
                        <div class="col">
                            <div class="product-list-card">
                                <div class="product-list-image"><img src="${pageContext.request.contextPath}/mironmahmud.com/ghurnek/assets/images/product/05.jpg" alt="product">
                                    <div class="product-list-badge"><label class="badge new">new</label></div>
                                    <div class="product-list-hints"><i
                                            class="material-icons">collections</i><span>4</span></div>
                                    <div class="product-list-overlay">
                        ...
                        <div class="col">
                            <div class="product-list-card">
                                <div class="product-list-image"><img src="${pageContext.request.contextPath}/mironmahmud.com/ghurnek/assets/images/product/06.jpg" alt="product">
                                    <div class="product-list-badge"><label class="badge new">new</label><label
                                            class="badge featured">featured</label></div>
                                    <div class="product-list-hints"><i
                                            class="material-icons">collections</i><span>4</span></div>
