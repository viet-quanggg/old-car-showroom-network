...
<section class="section-gap-100">
    <div class="container">
        <div class="row">
            ...
            <div class="col-xl-12">
                <div class="product-single-scrollspy-btns"><a href="#overview" class="nav-link" title="Overview"><i
                            ...
                            class="material-icons">smart_display</i><span>media</span></a><a href="#features"
                                                                                     class="nav-link" title="Features"><i class="material-icons">fact_check</i><span>features</span></a>

                    <a href="#brand" class="nav-link" title="Brand Catalogue"><i class="material-icons">local_offer</i><span>brand</span></a>
        ...
        <div class ="row">
            ...
            <div class ="col-xl-4">
                <div class="common-card" id="brand">
                    <div class="common-card-header">
                        <h4 class="common-card-header-title">brands</h4>
                    </div>
