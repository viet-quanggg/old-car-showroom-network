        ...
        <div class="row content-reverse">
            <div class="col-lg-4 col-xl-4">
                <div class="blog-widget">
                    <h5 class="blog-widget-title">Find User</h5>
                    <form class="blog-widget-form"><input type="text" placeholder="Search User"><button
                            type="submit" class="material-icons">search</button></form>
                </div>
                <div class="blog-widget">
                    <h5 class="blog-widget-title">Recent User</h5>
