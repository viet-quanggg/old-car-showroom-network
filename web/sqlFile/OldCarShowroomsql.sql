...
insert [dbo].[User] ([userEmail],[userPass],[userName],[userPhone],[userAddress],[timeCreated],[userRole],[userImage])
				values(N'admin@gmail.com','A665A45920422F9D417E4867EFDC4FB8A04A1F3FFF1FA07E998E86F7F7A27AE3',N'Admin',132465,N'SaiGon',CURRENT_TIMESTAMP,2,'/OldCarShowroom2/images/user/66f-1.jpg')
...
insert [dbo].[User] ([userEmail],[userPass],[userName],[userPhone],[userAddress],[timeCreated],[userRole],[userImage])
				values(N'nguyenvietquang099@gmail.com','A665A45920422F9D417E4867EFDC4FB8A04A1F3FFF1FA07E998E86F7F7A27AE3',N'Nguyễn Việt Quang',0919473970,N'Go Vap',CURRENT_TIMESTAMP,2,'/OldCarShowroom2/images/user/66f-1.jpg')
				insert [dbo].[User] ([userEmail],[userPass],[userName],[userPhone],[userAddress],[timeCreated],[userRole],[userImage])
				values(N'caothang7a7@gmail.com','A665A45920422F9D417E4867EFDC4FB8A04A1F3FFF1FA07E998E86F7F7A27AE3',N'Phạm Tuấn Cao Thăng',0796155919,N'District 1',CURRENT_TIMESTAMP,2,'/OldCarShowroom2/images/user/66f-1.jpg')
insert [dbo].[User] ([userEmail],[userPass],[userName],[userPhone],[userAddress],[timeCreated],[userRole],[userImage])
				values(N'moremoremotto1@gmail.com','A665A45920422F9D417E4867EFDC4FB8A04A1F3FFF1FA07E998E86F7F7A27AE3',N'Trần Phước Thịnh',132465,N'District 2',CURRENT_TIMESTAMP,2,'/OldCarShowroom2/images/user/66f-1.jpg')
				insert [dbo].[User] ([userEmail],[userPass],[userName],[userPhone],[userAddress],[timeCreated],[userRole],[userImage])
				values(N'meruem0812@gmail.com','A665A45920422F9D417E4867EFDC4FB8A04A1F3FFF1FA07E998E86F7F7A27AE3',N'Phùi Chếch Minh',132465,N'Binh Duong',CURRENT_TIMESTAMP,2,'/OldCarShowroom2/images/user/66f-1.jpg')
insert [dbo].[User] ([userEmail],[userPass],[userName],[userPhone],[userAddress],[timeCreated],[userRole],[userImage])
				values(N'mphamtran8@gmail.com','A665A45920422F9D417E4867EFDC4FB8A04A1F3FFF1FA07E998E86F7F7A27AE3',N'Phạm Trần Hoàng Minh',132465,N'District 2',CURRENT_TIMESTAMP,2,'/OldCarShowroom2/images/user/66f-1.jpg')
